          ...
          return Column(
            children: [
              ...
              CheckboxListTile(
                ...
                subtitle:
                    Text(user.isVerified ? '인증이 완료된 사용자입니다.' : '인증되지 않았습니다. 인증된 사용자로 전환 하시겠습니까?'),
                onChanged: (value) async {
                  ...
                  if (mounted) {
                    error(
                      ...
                      message: '사용자 인증 ${user.isVerified == true ? '완료되었습니다.' : '해제되었습니다.'}',
                    );
                  }
                },
              ),
              CheckboxListTile(
                ...
                subtitle: Text(user.isAdmin ? '관리자입니다. 관리자 권한을 해제하시겠습니까?' : '관리자로 설정하시겠습니까?'),
                onChanged: (value) async {
                  ...
                  if (mounted) {
                    error(
                      ...
                      message: '관리자 ${user.isAdmin == true ? '관리자로 지정되었습니다.' : '관리자 권한 해제되었습니다.'}',
                    );
                  }
                },
              ),
