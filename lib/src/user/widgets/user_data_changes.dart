...
/// 사용자 정보가 변경될 때마다 rebuild 를 하는 위젯
///
///
...
class UserDataChanges extends StatelessWidget {
  const UserDataChanges({super.key, required this.builder});
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<UserModel?>(
      stream: UserService.instance.userDataChanges,
      builder: (_, snapshot) {
        ...
        if (snapshot.hasError) {
          dog('error in UserDataChanges: ${snapshot.error}');
